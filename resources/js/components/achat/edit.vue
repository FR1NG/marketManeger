...
export default {
  ...
  methods: {
    ...
    getProvider() {
      this.overlay = true;
      this.$store
        .dispatch("employe/getEmploye", { id: this.$route.params.id })
        .then((response) => {
          const provider = response.data;
          this.form.id = provider.id;
          this.form.name = provider.name;
          this.form.cin = provider.cin;
          this.form.cnss = provider.cnss;
          this.form.phone = provider.phone;
          this.form.email = provider.email;
          this.form.address = provider.address;
          this.form.salery = provider.salery;
          this.form.quality = provider.quality;
