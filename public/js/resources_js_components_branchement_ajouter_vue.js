...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getCategories: function getCategories() {
      ...
      this.$store.dispatch("branchement/getCreateData").then(function () {
        _this2.categoriesLoading = false;
      });
    },
    getArticles: function getArticles(_ref) {
      var _this3 = this;

      var id = _ref.id;
      this.articlesLoading = true;
      this.$store.dispatch("branchement/getBranchementArticles", {
        id: id
      }).then(function () {
            ...
            [
              ...
              _c(
                ...
                [
                  _c("v-select", {
                    attrs: {
                      items: _vm.branchementArticles,
                      "item-text": "display_name",
                      "item-value": "id",
                      loading: _vm.articlesLoading,
                      label: "Branchement",
                      "error-messages": _vm.errors.market_article_id
                    },
                    model: {
                      value: _vm.form.market_article_id,
                      callback: function($$v) {
                        _vm.$set(_vm.form, "market_article_id", $$v)
                      },
                      expression: "form.market_article_id"
                    }
                  })
                ],
                1
